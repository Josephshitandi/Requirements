...
- `url`: The URL in [slugified](https://github.com/Josephshitandi/filenamify-url) form, eg. `http://yeoman.io/blog/` becomes `yeoman.io!blog`
...
A keyword is a version of a device from [this list](https://github.com/Josephshitandi/viewport-list/blob/master/data.json).
...
- [capture-website](https://github.com/Josephshitandi/capture-website) - A different take on screenshotting websites
